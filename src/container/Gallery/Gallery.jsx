    ...
    return (
        <div className="gallery flex-center">
            <div className="gallery-content">
                ...
                <p className="p-opensans" style={{ color: '#AAAAAA', marginTop: '2rem' }}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Volutpat mattis ipsum turpis elit elit scelerisque egestas mu.</p>
